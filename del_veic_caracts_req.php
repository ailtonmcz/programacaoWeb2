...
menu();
     ...
     $del_veiculos_caracteristicas = new PDO("pgsql:host=balarama.db.elephantsql.com port=5432 dbname=ajdemjnu user=ajdemjnu password=T1ZJIpsDUwwt-brNM8u2wX6x_ZESPTtU");
        try {
            $del_veiculos_caracteristicas = new PDO("pgsql:host=balarama.db.elephantsql.com port=5432 dbname=ajdemjnu user=ajdemjnu password=T1ZJIpsDUwwt-brNM8u2wX6x_ZESPTtU");
        ...
        $sql = "delete from veiculos_caracteristicas where id = '$del'";
        
        
        $del_veiculos_caracteristicas->exec($sql);
