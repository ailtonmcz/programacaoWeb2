...
<style type="text/css">
  ...
  <table border="5px" cellpadding="6px" cellspacing="0">
    <tr>
      <td><b><font size="5" color="black" face="Arial">Código do usuário</td>
      <td><b><font size="5" color="black" face="Arial">Código do funcionário</td>
      <td><b><font size="5" color="black" face="Arial">Username</td>
      <td><b><font size="5" color="black" face="Arial">Endereço</td>
      <td><b><font size="5" color="black" face="Arial">Setor</td>
   </tr>
...
<?php 
  ...
  <tr>
    ...
    <td><?php echo  '<b><font size="4" color="black" face="Arial">' . $dado['username']; ?></td>
    <td><?php echo  '<b><font size="4" color="black" face="Arial">' . $dado['endereco']; ?></td>
    <td><?php echo  '<b><font size="4" color="black" face="Arial">' . $dado['setor']; ?></td>
