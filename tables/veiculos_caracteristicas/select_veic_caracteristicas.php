...
<style type="text/css">
  ...
  <table border="5px" cellpadding="6px" cellspacing="0">
    <tr>
      <td><b><font size="5" color="black" face="Arial">Código</td>
      <td><b><font size="5" color="black" face="Arial">Código do veículo</td>
      <td><b><font size="5" color="black" face="Arial">Descrição</td>
   </tr>
...
<?php 
  ...
  <tr>
    ...
    <td><?php echo  '<b><font size="4" color="black" face="Arial">' . $dado['descricao']; ?></td>
